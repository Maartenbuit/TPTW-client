...
export default class AlliedGame extends React.Component {
  ...
  render() {
    console.log('this.props.alliedQuestions', this.props.alliedQuestions)
    const shuffled = this.shuffle(this.props.alliedQuestions[0].answers)
    ...
    return (
      <div>
        ...
        {/* <h3>Score: {this.props.rooms[0].users[0].score}</h3> */}
        <h1>Question: </h1>
